...
try:
    ...
    logging_setup.install_crash_logging("HosnyPOS-OCT")
except Exception:
    pass
...
class SqliteDatabase:
    ...
    def get_shift_summary(self, shift_id: int) -> Dict[str, Any]:
        ...
        return {
            ...
            "cash_collected": float(sales_by_method["cash_total"]) + float(res["paid"]) + float(deliver["total"]) - float(returns["total"]) + float(exchanges["total"]),
